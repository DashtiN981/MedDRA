...
OUT_JSON     = "/home/naghmedashti/MedDRA-LLM/Measure_TrueLLT_CandidateList/Mosaic_output_BaseB.json"
...
for idx, row in ae_df.iloc[:MAX_ROWS].iterrows():
    ...
    try:
        ...
        true_in_candidates = bool(true_llt_term) and (true_llt_term in closest_terms)

"""
File Name: RAGNew.py    === Author: Naghme Dashti / 26 January 2026

RAG-based Prompting with Explicit Reasoning + Final Answer Line
----------------------------------------------------------------
This script maps predicted LLT -> PT and PT -> SOC and reports LLT/PT and SOC accuracies without trueTerm in Candidate list
...
OUTPUT_FILE_NAME         = "Mosaic_output_RAGPipeline"
...
for idx, row in ae_df.iterrows():
    ...
    try:
        ...
        true_in_candidates = bool(true_LLT_term) and (true_LLT_term in candidate_terms)
        model_selected_true = bool(true_LLT_term) and bool(pred_LLT_term_std) and (pred_LLT_term_std == true_LLT_term)
...
# =========================
out_json = f"/home/naghmedashti/MedDRA-LLM/Measure_TrueLLT_CandidateList/{OUTPUT_FILE_NAME}_seed{RUN_SEED}.json"
...
metrics_json_path = f"/home/naghmedashti/MedDRA-LLM/Measure_TrueLLT_CandidateList/{OUTPUT_FILE_NAME}_metrics_seed{RUN_SEED}.json"

...
AE_CSV_PATH  = "/home/naghmedashti/MedDRA-LLM/data/KI_Projekt_Delta_AE_Codierung_2023_02_08.csv"
OUT_JSON     = "/home/naghmedashti/MedDRA-LLM/Baseline_LLM_Models/Delta_output_zeroshot.json"
...
for idx, row in ae_df.iloc[:MAX_ROWS].iterrows():
    ...
    try:
        ...
        pred_llt_code = llt_term_to_code.get(key)

...
plt.tight_layout()
plt.savefig("./data/Statistics_Images/pt_count_by_soc_en_labeled.png")
...
for bar in bars2:
    plt.text(bar.get_width() + 50, bar.get_y() + bar.get_height()/2, str(bar.get_width()), va='center')
plt.tight_layout()
plt.savefig("./data/Statistics_Images/llt_count_by_soc_en_labeled.png")
...
plt.tight_layout()
plt.savefig("./data/Statistics_Images/llt_pt_ratio_by_soc_en_labeled.png")

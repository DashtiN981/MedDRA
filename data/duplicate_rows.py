...
file_path = 'data/MedDRA_PT_SOC_25_0.xlsx'
...
duplicates.to_excel('data/duplicates_pt.xlsx', index=False)

# Print summary
print(f"{len(duplicates)} rows with duplicated values in column '{column_name}' saved to 'duplicates_pt.xlsx'.")

...
llt_df = pd.read_csv("/home/naghmedashti/MedDRA-LLM/data/MedDRA2_LLT_Code_25_0.csv", sep=';', encoding='latin1', engine='python')
pt_df = pd.read_csv("/home/naghmedashti/MedDRA-LLM/data/MedDRA_PT_SOC_25_0.csv", sep=';', encoding='latin1', engine='python')

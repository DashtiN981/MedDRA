...
exact_match_count = sum(1 for d in data if d.get("exact_match") is True)
fuzzy_match_count = sum(1 for d in data if d.get("fuzzy_match") is True)
...
# Save plot
output_path = "./Visualization/other/reasoning_v3_accuracy_comparison_Mosaic.png"
plt.tight_layout()

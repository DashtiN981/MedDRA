...
## === Parameters ===
TOP_K = 10 # Top Similar LLT to each AE
MAX_ROWS = 100 # Number of dataset records
EMB_DIM = 384  # dimension of MiniLM

# ِDataset files include KI_Projekt_Mosaic_AE_Codierung_2024_07_03, KI_Projekt_Dauno_AE_Codierung_2022_10_20,KI_Projekt_Delta_AE_Codierung_2023_02_08
# And embedded datasets include ae_embeddings_Mosaic, ae_embeddings_Dauno, ae_embeddings_Delta  
DATASET_NAME = "KI_Projekt_Delta_AE_Codierung_2023_02_08"  
DATASET_EMB_NAME = "ae_embeddings_Delta"  

# MedDRA LLT dictionary and output file
LLT_DICTIONARY_NAME = "LLT2_Code_English_25_0" 
LLT_DICTIONARY_EMB_NAME = "llt2_embeddings"
OUTPUT_FILE_NAME = "Delta_output_v3" 
...
LLM_API_NAME = "Llama-3.3-70B-Instruct" # llama-3.3-70b-instruct-awq
LLM_TEMP = 0.0
LLM_TOKEN = 250
...
# --- Main Loop ---
for idx, row in ae_df.iloc[:].iterrows(): # OR ae_df.iloc[:MAX_ROWS]
...
# === Save Results ===
with open(f"/home/naghmedashti/MedDRA-LLM/RAG_Models/{OUTPUT_FILE_NAME}.json", "w") as f:

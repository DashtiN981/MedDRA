"""
File Name: RAG_parallel.py   === Author: Naghme Dashti / patched for parallel requests
...
# =========================
# توصیه: کلید را از env بخوان
API_KEY = "sk-aKGeEFMZB0gXEcE51FTc0A"  # <-- کلیدت را اینجا بگذار یا از env بخوان
...
OUTPUT_FILE_NAME         = "Dauno_outputParallel"

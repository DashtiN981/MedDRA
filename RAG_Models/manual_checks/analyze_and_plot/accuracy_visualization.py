...
# file_path = "./Visualization/other/manualcheck_results_reasoning_v3_final.json"
file_path = "/home/naghmedashti/MedDRA-LLM/RAG_Models/manual_checks/Dauno_output__checked__reviewer1.json"
...
plt.ylim(0, 100)
plt.ylabel("Accuracy (%)")
plt.title("Accuracy Comparison Mosaic Dataset")
...
# Save plot
output_path = "/home/naghmedashti/MedDRA-LLM/RAG_Models/manual_checks/Dauno_output__checked__reviewer1.png"
plt.tight_layout()
